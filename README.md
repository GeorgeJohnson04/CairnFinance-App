Make this less AI sounding and remove AI Jargon
Leavepurple hearts as thats the whole brand
<div align="center">

# 💜 Cairn

Track your savings, investments, dividends, and financial goals in one place.

Cairn is a secure, multi-user personal finance web app designed to completely replace (and fix) your old finance spreadsheets.

Not financial advice. Cairn is just a tracking and modeling tool. We don't offer financial, investment, tax, or legal advice, nor do we recommend buying or selling any securities. Projections are hypothetical, and market data might be delayed. You are responsible for your own financial decisions.
##  Features

| | |
|---|---|
| **Private accounts** |Create an account and see only your data. We strictly isolate user data at the database level. |
| **Dashboard** | View your total value, unrealized & realized P&L, total return, and allocations by account, asset type, or industry.|
| **Growth chart** | Visualize cumulative money earned or lost over time with a clean area chart, plus a forward-looking value curve. |
| **All-asset portfolio** | Track stocks, ETFs, mutual funds, crypto, bonds, options, real estate, commodities, cash, and anything else. |
| **Live ticker search** | Search for a symbol or company name to get live results and current prices powered by Yahoo Finance. |
| **Smart trade log** | Log your buys and sells. Your holdings, average cost basis, and realized P&L update automatically. |
| **Income tracker** | Monitor dividends and interest by type and account, including your year-to-date income. |
| **Financial plan** | Input your income & expenses to see your monthly surplus, savings rate, and emergency fund status. Get a sample investing posture (ranging from Aggressive to Capital Preservation) with a projected stock/bond/cash split |
| **Savings & goals** | Track goal progress and monitor your combined Roth/IRA contributions across all retirement accounts. |
| **Live price refresh** | Update stock, ETF, mutual fund, and crypto prices with a single click. |
